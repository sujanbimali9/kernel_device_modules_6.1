...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	tianma_dcs_write_seq_static(ctx, 0x65, 0x99);
	tianma_dcs_write_seq_static(ctx, 0x69, 0xDD);
	tianma_dcs_write_seq_static(ctx, 0x6D, 0x99);
	...
	tianma_dcs_write_seq_static(ctx, 0xEC, 0x4B, 0x4B, 0x4B, 0x4B, 0x5A, 0x5A, 0x5A, 0x5A,
			0xE1, 0xE1, 0xE1, 0xE1);
	...
	tianma_dcs_write_seq_static(ctx, 0xFB, 0x01);
	tianma_dcs_write_seq_static(ctx, 0x75, 0x00, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x76, 0x01, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x77, 0x03, 0x05);
	tianma_dcs_write_seq_static(ctx, 0x78, 0x01, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x7A, 0x63, 0x63);
	...
	tianma_dcs_write_seq_static(ctx, 0xBA, 0x12, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xBB, 0x10, 0x00);
	tianma_dcs_write_seq_static(ctx, 0xBC, 0x37, 0x00, 0x30);
	tianma_dcs_write_seq_static(ctx, 0xFF, 0x24);
	tianma_dcs_write_seq_static(ctx, 0xFB, 0x01);
	tianma_dcs_write_seq_static(ctx, 0x00, 0x03, 0x03, 0x03, 0x03, 0x03, 0x04, 0x26, 0x26,
			0x0F, 0x0D, 0x0E, 0x0C, 0x27, 0x21, 0x22, 0x23);
	tianma_dcs_write_seq_static(ctx, 0x01, 0x03, 0x03, 0x2E, 0x2C, 0x03, 0x03, 0x03, 0x03);
	tianma_dcs_write_seq_static(ctx, 0x02, 0x03, 0x03, 0x03, 0x03, 0x03, 0x04, 0x26, 0x26,
			0x0F, 0x0D, 0x0E, 0x0C, 0x27, 0x21, 0x24, 0x25);
	tianma_dcs_write_seq_static(ctx, 0x03, 0x03, 0x03, 0x2E, 0x2C, 0x03, 0x03, 0x03, 0x03);
	...
	tianma_dcs_write_seq_static(ctx, 0x3A, 0x63);
	...
	tianma_dcs_write_seq_static(ctx, 0x5B, 0x79);
	...
	tianma_dcs_write_seq_static(ctx, 0x92, 0x8D, 0x01, 0x2D);
	tianma_dcs_write_seq_static(ctx, 0x93, 0x1A, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x94, 0x7A, 0x00);
	...
	tianma_dcs_write_seq_static(ctx, 0xAA, 0x96, 0x96, 0x25);
	...
	tianma_dcs_write_seq_static(ctx, 0x13, 0x03);
	tianma_dcs_write_seq_static(ctx, 0x14, 0x24);
	tianma_dcs_write_seq_static(ctx, 0x15, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x16, 0x5B);
	tianma_dcs_write_seq_static(ctx, 0x1F, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x20, 0x79);
	tianma_dcs_write_seq_static(ctx, 0x23, 0x09);
	tianma_dcs_write_seq_static(ctx, 0x24, 0x31);
	tianma_dcs_write_seq_static(ctx, 0x26, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x27, 0x79);
	tianma_dcs_write_seq_static(ctx, 0x2A, 0x09);
	tianma_dcs_write_seq_static(ctx, 0x2B, 0x31);
	tianma_dcs_write_seq_static(ctx, 0x33, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x34, 0x79);
	tianma_dcs_write_seq_static(ctx, 0x37, 0x09);
	tianma_dcs_write_seq_static(ctx, 0x38, 0x31);
	...
	tianma_dcs_write_seq_static(ctx, 0x62, 0x79);
	tianma_dcs_write_seq_static(ctx, 0x65, 0x09);
	tianma_dcs_write_seq_static(ctx, 0x66, 0x31);
	...
	tianma_dcs_write_seq_static(ctx, 0xDB, 0x03);
	tianma_dcs_write_seq_static(ctx, 0xDC, 0x96);
	tianma_dcs_write_seq_static(ctx, 0xDD, 0x02);
	tianma_dcs_write_seq_static(ctx, 0xDE, 0xB0);
	...
	tianma_dcs_write_seq_static(ctx, 0x13, 0x88);
	tianma_dcs_write_seq_static(ctx, 0x14, 0x8E);
	...
	tianma_dcs_write_seq_static(ctx, 0x1B, 0x1B, 0x1C, 0x1C, 0x1C);
	tianma_dcs_write_seq_static(ctx, 0x1C, 0x89, 0xEA, 0xEA, 0xEA);
	tianma_dcs_write_seq_static(ctx, 0x1D, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x1E, 0x8D);
	tianma_dcs_write_seq_static(ctx, 0x1F, 0x8D);
	tianma_dcs_write_seq_static(ctx, 0x24, 0x01);
	tianma_dcs_write_seq_static(ctx, 0x25, 0x8D);
	tianma_dcs_write_seq_static(ctx, 0x2A, 0x1C, 0x1D, 0x16, 0x0F);
	tianma_dcs_write_seq_static(ctx, 0x2B, 0xD3, 0xA9, 0x9C, 0x7C);
	tianma_dcs_write_seq_static(ctx, 0x2D, 0x00, 0x00, 0x00, 0x0E, 0x00, 0xC0, 0x0F, 0x04,
			0x00);
	tianma_dcs_write_seq_static(ctx, 0x2F, 0x04);
	tianma_dcs_write_seq_static(ctx, 0x30, 0x8D);
	tianma_dcs_write_seq_static(ctx, 0x32, 0x8D);
	...
	tianma_dcs_write_seq_static(ctx, 0x3A, 0x8D);
	tianma_dcs_write_seq_static(ctx, 0x3D, 0x00, 0x80,0x28, 0x20);
	tianma_dcs_write_seq_static(ctx, 0x3F, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x40, 0x85);
	tianma_dcs_write_seq_static(ctx, 0x41, 0x85);
	tianma_dcs_write_seq_static(ctx, 0x42, 0x85);
	tianma_dcs_write_seq_static(ctx, 0x43, 0x01);
	tianma_dcs_write_seq_static(ctx, 0x44, 0x85);
	tianma_dcs_write_seq_static(ctx, 0x45, 0x04);
	tianma_dcs_write_seq_static(ctx, 0x46, 0x85);
	tianma_dcs_write_seq_static(ctx, 0x48, 0x85);
	tianma_dcs_write_seq_static(ctx, 0x49, 0x04);
	tianma_dcs_write_seq_static(ctx, 0x4A, 0x85);
	tianma_dcs_write_seq_static(ctx, 0x4D, 0x5B);
	...
	tianma_dcs_write_seq_static(ctx, 0x52, 0x71);
	...
	tianma_dcs_write_seq_static(ctx, 0x58, 0x71);
	tianma_dcs_write_seq_static(ctx, 0x5B, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x5C, 0x71);
	tianma_dcs_write_seq_static(ctx, 0x60, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x61, 0x71);
	tianma_dcs_write_seq_static(ctx, 0x64, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x65, 0x71);
	tianma_dcs_write_seq_static(ctx, 0x69, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x6A, 0x71);
	tianma_dcs_write_seq_static(ctx, 0x6E, 0x5B);
	...
	tianma_dcs_write_seq_static(ctx, 0x73, 0x71);
	tianma_dcs_write_seq_static(ctx, 0x74, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x75, 0x72);
	tianma_dcs_write_seq_static(ctx, 0x7B, 0x5B);
	...
	tianma_dcs_write_seq_static(ctx, 0x80, 0xCC);
	tianma_dcs_write_seq_static(ctx, 0x81, 0xCC);
	tianma_dcs_write_seq_static(ctx, 0x82, 0x00, 0x4C, 0x4C, 0x4C);
	tianma_dcs_write_seq_static(ctx, 0x84, 0x2D, 0x2D, 0x2D);
	tianma_dcs_write_seq_static(ctx, 0x8B, 0x64);
	tianma_dcs_write_seq_static(ctx, 0x8C, 0x05);
	...
	tianma_dcs_write_seq_static(ctx, 0x93, 0x33);
	tianma_dcs_write_seq_static(ctx, 0x94, 0x32);
	tianma_dcs_write_seq_static(ctx, 0x96, 0x01);
	...
	tianma_dcs_write_seq_static(ctx, 0x9B, 0x0F, 0x0F, 0x0F, 0x0F);
	tianma_dcs_write_seq_static(ctx, 0x9C, 0x6F, 0x5F, 0x5F, 0x5F);
	...
	tianma_dcs_write_seq_static(ctx, 0xCD, 0x2B, 0x49);
	tianma_dcs_write_seq_static(ctx, 0xCE, 0x29, 0x4A);
	tianma_dcs_write_seq_static(ctx, 0xCF, 0x01, 0x00, 0x24);
	...
	tianma_dcs_write_seq_static(ctx, 0x5B, 0x76);
	...
	tianma_dcs_write_seq_static(ctx, 0x79, 0xAE);
	tianma_dcs_write_seq_static(ctx, 0x7A, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x7B, 0x77);
	tianma_dcs_write_seq_static(ctx, 0x7D, 0x04);
	tianma_dcs_write_seq_static(ctx, 0x7E, 0x42);
	tianma_dcs_write_seq_static(ctx, 0x7F, 0x03);
	tianma_dcs_write_seq_static(ctx, 0x80, 0xC2, 0x07);
	tianma_dcs_write_seq_static(ctx, 0x81, 0x23, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x82, 0x36, 0x40);
	tianma_dcs_write_seq_static(ctx, 0x83, 0x12, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x84, 0x20, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x85, 0x1F, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x86, 0x36, 0x40);
	tianma_dcs_write_seq_static(ctx, 0x87, 0x12, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x88, 0x20, 0x00);
	...
	tianma_dcs_write_seq_static(ctx, 0x16, 0x2D);
	tianma_dcs_write_seq_static(ctx, 0x17, 0x09);
	tianma_dcs_write_seq_static(ctx, 0x18, 0x2D);
	tianma_dcs_write_seq_static(ctx, 0x19, 0x09);
	tianma_dcs_write_seq_static(ctx, 0x1A, 0x2D);
	tianma_dcs_write_seq_static(ctx, 0x1B, 0x09);
	tianma_dcs_write_seq_static(ctx, 0x1C, 0x2D);
	...
	tianma_dcs_write_seq_static(ctx, 0x30, 0x02);
	tianma_dcs_write_seq_static(ctx, 0x32, 0xB0);
	tianma_dcs_write_seq_static(ctx, 0x33, 0xC9);
	tianma_dcs_write_seq_static(ctx, 0x35, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x4B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	tianma_dcs_write_seq_static(ctx, 0xB9, 0x98, 0x00, 0x6F, 0x00, 0xCB, 0xB7, 0x14, 0x5F,
			0x41);
	tianma_dcs_write_seq_static(ctx, 0xBA, 0xAA, 0xAA, 0xA5, 0xA5, 0xE1, 0xE1, 0xFF, 0xFF);
	tianma_dcs_write_seq_static(ctx, 0xBB, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x55, 0xAA, 0x55,
			0x38, 0xC7, 0x38, 0xC7, 0xFF, 0xFF, 0xFF, 0xFF);
	...
	tianma_dcs_write_seq_static(ctx, 0xC6, 0x31);
	...
	tianma_dcs_write_seq_static(ctx, 0xFB, 0x01);
	tianma_dcs_write_seq_static(ctx, 0x3B, 0x03, 0x7A, 0x1A, 0x0A, 0x0A, 0x00);
	tianma_dcs_write_seq_static(ctx, 0x90, 0x13);
	tianma_dcs_write_seq_static(ctx, 0x91, 0x89, 0x28, 0x00, 0x14, 0xD2, 0x00, 0x00, 0x00,
			0x02, 0xA1, 0x00, 0x14, 0x05, 0x7A, 0x01, 0xDA);
	tianma_dcs_write_seq_static(ctx, 0x92, 0x10, 0xE0);
	tianma_dcs_write_seq_static(ctx, 0x9D, 0x01);
	tianma_dcs_write_seq_static(ctx, 0xB2, 0x00);
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("It's panel-tianma-tl1270100-120hz\n");
...
MODULE_DESCRIPTION("tianma tl1270100 wqxga2944 120Hz DPHY sPanel Driver");
MODULE_LICENSE("GPL");
